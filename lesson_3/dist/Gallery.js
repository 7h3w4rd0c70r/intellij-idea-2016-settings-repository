...
var App = function(props) {
	this.loader = new loaders_Loader(parsers_Gallery.parse,"/list.json");
	React.Component.call(this);
	this.state = { gallery : null};
};
App.__name__ = true;
App.main = function(nodeId) {
	ReactDOM.render({ "$$typeof" : $$tre, type : App, props : { }},window.document.getElementById(nodeId));
};
App.__super__ = React.Component;
App.prototype = $extend(React.Component.prototype,{
	componentDidMount: function() {
		this.loader.listen($bind(this,this.onGalleryLoad));
		this.loader.load();
	}
	,onGalleryLoad: function(gallery) {
		this.setState({ gallery : gallery});
	}
	,render: function() {
		if(this.state.gallery == null) {
			return { "$$typeof" : $$tre, type : "div", props : { className : "ui active page dimmer", children : { "$$typeof" : $$tre, type : "div", props : { className : "ui huge text loader", children : "Loading gallery..."}}}};
		}
		return { "$$typeof" : $$tre, type : viewers_Gallery, props : { gallery : this.state.gallery}};
	}
});
...
var viewers_Gallery = function(props) {
	this.images = [];
	var _gthis = this;
	React.Component.call(this);
	props.gallery.images.map(function(image) {
		_gthis.images.push({ "$$typeof" : $$tre, type : viewers_Image, props : { image : image}});
	});
};
viewers_Gallery.__name__ = true;
viewers_Gallery.__super__ = React.Component;
viewers_Gallery.prototype = $extend(React.Component.prototype,{
	render: function() {
		return { "$$typeof" : $$tre, type : "div", props : { children : [{ "$$typeof" : $$tre, type : "div", props : { className : "gallery-title", children : this.props.gallery.title}},{ "$$typeof" : $$tre, type : "div", props : { children : this.images}}]}};
	}
});
var viewers_Image = function(props) {
	React.Component.call(this);
};
viewers_Image.__name__ = true;
viewers_Image.__super__ = React.Component;
viewers_Image.prototype = $extend(React.Component.prototype,{
	render: function() {
		var tmp = $$tre;
		var tmp1 = "http://localhost/gallery/" + Std.string(this.props.image.src);
		return { $$typeof : tmp, type : "div", props : { className : "container", children : [{ "$$typeof" : $$tre, type : "img", props : { src : tmp1, className : "image"}},{ "$$typeof" : $$tre, type : "div", props : { className : "middle", children : { "$$typeof" : $$tre, type : "div", props : { className : "text", children : this.props.image.title}}}}]}};
	}
});
...
App.displayName = "App";
viewers_Gallery.displayName = "Gallery";
viewers_Image.displayName = "Image";
